"""
Excel schedule to JSON converter for calendar view

This script reads the session_schedule_by_slot.xlsx file and converts it to a JSON format 
that can be used for a calendar view of the conference schedule.
"""
